...
func take_damage(amount):
	...
	if hp <= 0:
		...
		if has_phoenix_feather:
			...
			CombatUI.update_hp_bar("Player1", hp, hp_max)
...
func heal(amount: int):
	...
	print("[Player1] Healed for ", actual_heal, " HP (", old_hp, " → ", hp, ")")
	CombatUI.update_hp_bar("Player1", hp, hp_max)
...
func use_bandages():
	...
	print("🩹 [Player1] Used Bandages - regeneration applied")
...
func use_health_potion():
	...
	heal(50)
	print("💊 [Player1] Used Health Potion")

func use_resolve_potion():
	"""Restore 2 Resolve points"""
	ResolveManager.add_resolve("Player1", 2)
	print("🔋 [Player1] Used Resolve Potion")
...
func use_phoenix_feather():
	...
	print("🔥 [Player1] Used Phoenix Feather - revival protection active")
...
func use_pain_killer():
	...
	print("🛡️ [Player1] Used Pain Killer - damage immunity active")
